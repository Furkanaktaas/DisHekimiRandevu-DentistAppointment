<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SekreterPanel.aspx.cs" Inherits="WebProjeTemplate.SekreterPanel" %>
                ...
                <div class="row">
                    <div class="col-md-4 border-right element-animate" data-animate-effect="fadeInLeft">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true"><span>01</span> Randevular</a>
                    ...
                    <div class="col-md-7 element-animate" data-animate-effect="fadeInLeft">
                        <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateDeleteButton="True" DataKeyNames="randevuId" OnRowDeleting="GridView1_RowDeleting1"></asp:GridView>
                                ...
                                <asp:Label ID="klinikIdLbl" runat="server" Visible="False"></asp:Label>
                            </div>
                            <!-- Randevular kısmı son --------------------------------------------------------------- -->
                            ...
                            <!-- Şifre Değiştir kısmı kısmı son ----------------------------------------------- -->
                        </div>
                    </div>
                </div>
            </div>
